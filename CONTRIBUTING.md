...
Icinga Web 2 Module Globe 3D is an open source project and lives from your ideas and contributions.
...
Please consider our [roadmap](https://github.com/mikesch-mp/globe/milestones) and
[open issues](https://github.com/mikesch-mp/globe/issues) when you start contributing
to the project.

Before starting your work on this Icinga Web 2 Module Globe 3D, you should [fork the project](https://help.github.com/articles/fork-a-repo/)
...
```
git clone git@github.com:dnsmichi/icingaweb2-module-globe.git
cd icingaweb2-module-globe
```

Add a new remote `upstream` with this repository as value.

```
git remote add upstream https://github.com/Mikesch-mp/icingaweb2-module-globe.git
```
...
[Icinga 2 Vagrant boxes](https://github.com/icinga/icinga-vagrant).
    ...
    $ vagrant up
    $ vagrant ssh -c "cd /usr/share/icingaweb2/modules/globe && sudo git pull"

## <a id="contributing-patches-source-code"></a> Source Code Patches

Icinga Web 2 Module Globe 3D is written in PHP and JavaScript. This module relies on the base
framework.
